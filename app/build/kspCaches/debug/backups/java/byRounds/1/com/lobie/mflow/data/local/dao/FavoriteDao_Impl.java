...
public final class FavoriteDao_Impl implements FavoriteDao {
  ...
  public FavoriteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfFavoriteEntity = new EntityInsertionAdapter<FavoriteEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `favorites` (`songId`,`title`,`artist`,`album`,`durationMs`,`thumbnailUrl`,`addedAt`) VALUES (?,?,?,?,?,?,?)";
      }
    ...
    this.__preparedStmtOfRemoveFavorite = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "DELETE FROM favorites WHERE songId = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object removeFavorite(final String songId, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
      ...
      public List<FavoriteEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new FavoriteEntity(_tmpSongId,_tmpTitle,_tmpArtist,_tmpAlbum,_tmpDurationMs,_tmpThumbnailUrl,_tmpAddedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<Boolean> isFavorite(final String songId) {
